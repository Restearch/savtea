        ...
        <div class="col-12 col-md-6 mb-5">
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div>
                    ...
                    <img src="../image/<?php echo $data ['foto']?>" alt="" class="form-control" width="200px">
                </div>
                <div>
                ...
                <div class="d-flex justify-content-between">
                    <button typr="submit" class="btn btn-primary" name="simpan">Simpan</button>
                    <button typr="submit" class="btn btn-danger" name="hapus">Hapus</button>
                </div>
            </form> 
